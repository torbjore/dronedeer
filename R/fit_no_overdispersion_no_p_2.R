...
source("R/nimble_models/nimbleCode_no_overdispersion_no_p_2.q")
...
DoubleObsMultisiteConf <- configureMCMC(DoubleObsMultisiteModel, 
                                        ...
                                        monitors = c("Disc_New_Y", "Disc_Y", "mu0", "beta", "mean_ds"),
                                        enableWAIC = TRUE)
...
# Saving workspace
save(settings, out, file = "posterior_samples/no_overdispersion_no_p_2.RData")
