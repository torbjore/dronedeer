...
Results from model fitted to simulated data. 8 areas with 100 sites. Parameters set to posterior mean of original fit. Same priors as original.
...
load("../data/posterior_samples/sim_gamma_2_run1.RData")
gelman.diag(out)
#plot(out$samples)
summary(out)
