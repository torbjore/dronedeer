...
source("R/nimble_models/nimbleCode_DOMM_gamma_2_superwide.q")
...
# These were adjusted for sd = 5, but not used in current version of "super-wide":
# lambdahat[3] <- 2.096e-03 # Raa (April)
# lambdahat[4] <- 1.174e-03 # Raa (March)
# lambdahat[7] <- 1.268e-03 # Sprakehaug (April)
...
# Saving workspace
save(settings, out, file = "data/posterior_samples/gamma_2_superwide.RData")
