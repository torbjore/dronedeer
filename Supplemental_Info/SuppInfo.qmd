...
marginal_mean_density <- mean(df$mean)/100
```
...
x <- seq(Median, 4.5, length.out = 100)
plot(dgamma(x, a, b) ~ x, type = "n", xlab = "Deer density (x)", ylab = "f(x)", xaxs = "i", yaxs = "i", xlim = c(0,4.5))
