...
* `mean_x`: The mean UTM x-coordinate (east) of all pixels within a focal image, representing the average horizontal position across the entire image.

* `mean_y`: The mean UTM y-coordinate (north) of all pixels within a focal image, representing the average vertical position across the entire image.
