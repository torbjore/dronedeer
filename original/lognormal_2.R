...
#setwd("D:/Dropbox (UiO)/Deer/Analysis/Model")
...
DoubleObsMultisiteConf <- configureMCMC(DoubleObsMultisiteModel, monitors = c("median_lambda", "mean_lambda" , "p1", "p2", "mu0", "sigma", "beta", "x_at_peak"), enableWAIC = TRUE) #POW2
...
save(posterior_lognormal_2, file = "Manuscript_models/posterior_lognormal_2.RData")
